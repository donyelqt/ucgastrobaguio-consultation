  ...
  <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
      ...
      <div className="lg:py-24">
        <h2 className="text-3xl font-bold sm:text-3xl"><span className='text-primary'style={{ fontFamily: '"Lucida Fax Demi", serif' }}>UC GastroBaguio</span><span style={{ fontFamily: '"Lucida Fax Demi", serif' }}> - Consultation System</span></h2>
